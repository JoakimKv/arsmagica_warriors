...
class FileOperation:
   ...
   def copy_file_to_folder(self, source_path, destination_folder):
   ...
   def split_filepath_to_file_and_folder(self, file_path):
         
         # Split the "file path" to the "folder path" and the "file name".
   ...
   def copy_file(self, source_path, destination_path):
      ...
      try:
         ...
         # Split the "file path" to the "folder path" and the "file name".
         destination_folder, filename = os.path.split(destination_path)
   ...
   def is_the_file_there(self, file_path):
   ...
   def is_the_folder_there(self, folder_path):
